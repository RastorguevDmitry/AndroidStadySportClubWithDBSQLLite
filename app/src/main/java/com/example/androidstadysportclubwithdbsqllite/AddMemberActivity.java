...
import static com.example.androidstadysportclubwithdbsqllite.data.ClubOlimpusContract.MemberEntry;
...
public class AddMemberActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (!TextUtils.isEmpty(selectedGender)) {
                    if (selectedGender.equals("Male")) {
                        ...
                        gender = MemberEntry.GENDER_FEMAIL;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (currentMemberUri == null) {
            MenuItem menuItem = menu.findItem(R.id.delit_member);
    ...
    private void deletMember() {
        if (currentMemberUri != null) {
            ...
            if (rowsDeleted == 0) {
                Toast.makeText(this, "Удаление данных не удалось", Toast.LENGTH_LONG).show();
            } else  Toast.makeText(this, "Данные удалены", Toast.LENGTH_LONG).show();
        }
        finish();
    }
    ...
    private void saveMember() {
        ...
        if (TextUtils.isEmpty(firstName)) {
            ...
            Toast.makeText(this, "Input a sport", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        contentValues.put(MemberEntry.COLUMN_SPORTS, sport);
        ...
        if (currentMemberUri == null) {
            ...
            if (rowsChanged == 0) {
                Toast.makeText(this, "Saving of data in the tsble faleed  ", Toast.LENGTH_LONG).show();
            } else Toast.makeText(this, "Member Updated ", Toast.LENGTH_LONG).show();
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        if (data.moveToFirst()) {
            ...
            int sportColumnIndex = data.getColumnIndex(MemberEntry.COLUMN_SPORTS);
            ...
            switch (gender) {
                case MemberEntry.GENDER_MALE:
                    ...
                    break;
                case MemberEntry.GENDER_FEMAIL:
